...
- Check on your **FastQC** runs from Tuesday. Do you think all 6 completed or no?
...
- Data Carpentry Genomics Command Line
   - Navigation lessons
   - Files and Directories lesson
   - Redirection lesson
   - Scripting lesson
   - Data Carpentry's Project Organization lesson
- Data Carpentry's Genomics Wrangling
   - FastQC
...
## Data Wrangling: Quality Control, Trimming, Filtering, For loops, tmux, uploading/downloading
...
- [Data Carpentry - Data Wrangling 00: Assessing Read Quality https://rltillett.github.io/wrangling-genomics/00-quality-control/index.html](https://rltillett.github.io/wrangling-genomics/00-quality-control/index.html)
    ...
    - unzipping files
    - for loops (shell programming control)
