# BCH 709 Lecture notes: Week 13, part 1
...
---
## Today: R - a github publishing demo, data manipulation, ggplot

We'll begin today with a live demo on how to publish webpages using your github accounts. We'll start with the R notebook and web page we made last time for the gather and spread functions. Then we'll return to our fork of R for social science to learn how to get data out of R, and then how to deal with plotting functions.
