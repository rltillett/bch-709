# BCH 709 Lecture notes: Week 14, part 2
...
We'll start from their "Day 1" lesson, which I've rebuilt for us to update the Bioconductor instructions and so the images don't 404 ERROR. Our copy of Day 1 is here: [https://rltillett.github.io/BAD_days/Tutorial.html](https://rltillett.github.io/BAD_days/Tutorial.html)
There are additional pages for this section I've also re-rendered, and we'll cover these today too, if time permits:

* [https://rltillett.github.io/BAD_days/Frequency.html](https://rltillett.github.io/BAD_days/Frequency.html)
