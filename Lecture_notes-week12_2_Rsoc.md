# BCH 709 Lecture notes: Week 12, part 2
...
---
## Today: R - gather/spread, R notebooks, data manipulation, ggplot

We'll begin today with a lesson on the `gather()` and `spread()` functions (from _tidyr_, part of the _tidyverse_) which I wrote and made into a web page entirely using a special kind of R script called an **R Notebook** (invented by and for Rstudio, I believe). Then we'll return to our fork of R for social science to learn how to get data out of R, and then how to deal with plotting functions.

* To begin, visit this page, about gather, spread, and R Notebooks [https://rltillett.github.io/bch-709/Rnotebooks/gapminder.nb.html](https://rltillett.github.io/bch-709/Rnotebooks/gapminder.nb.html)
* After that, [we return to the dplyr/tidyr lesson for learning data export](https://rltillett.github.io/r-socialsci/03-dplyr-tidyr/index.html)
* Then onto the last section of the "R-4-soc" fork, [making plots with ggplot](https://rltillett.github.io/r-socialsci/04-ggplot2/index.html)
